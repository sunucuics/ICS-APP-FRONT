...
mixin _$AdminStats {
  ...
  int get pendingComments => throw _privateConstructorUsedError;
...
class _$AdminStatsImpl implements _AdminStats {
  ...
  @override
  String toString() {
    return 'AdminStats(totalUsers: $totalUsers, totalOrders: $totalOrders, totalRevenue: $totalRevenue, activeDiscounts: $activeDiscounts, pendingComments: $pendingComments, upcomingAppointments: $upcomingAppointments, lowStockProducts: $lowStockProducts, totalProducts: $totalProducts, totalServices: $totalServices)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pendingComments, pendingComments) ||
                other.pendingComments == pendingComments) &&
...
abstract class _AdminStats implements AdminStats {
  const factory _AdminStats(
      ...
      final int lowStockProducts,
      final int totalProducts,
      final int totalServices}) = _$AdminStatsImpl;
...
class _$AdminDashboardDataImpl implements _AdminDashboardData {
  ...
  @override
  String toString() {
    return 'AdminDashboardData(stats: $stats, recentOrders: $recentOrders, upcomingAppointments: $upcomingAppointments, lowStockProducts: $lowStockProducts, recentUsers: $recentUsers)';
  }
...
abstract class _AdminDashboardData implements AdminDashboardData {
  const factory _AdminDashboardData(
      {required final AdminStats stats,
